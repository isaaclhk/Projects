...
The results of this analysis show that length of stay in the hospital, age, gender, having metstatic cancer, pneumonia, and socioeconomic status of a participants' neighbourhood are factors that influence survival rates of heart failure patients. patients typically have a 1.2% increase in hazard ratios for each additional day of staying at the hospital. Males generally have a 32.5% higher hazard ratios for mortality compared to females. Those with metstatic cancer have hazard ratios that are on average 9.63 times higher than those without. The confidence intervals for metastatic cancer is large (4.65 to 19.94), hence the prediction is not precise. However, the result is highly statistically significant and should convince us that metastatic cancer increases mortality rates in patients with heart failure. Patients with pneumonia, on average have 48% higher hazard ratios compared to those without. Lastly, patients who live in regions associated with quintile 2 have 31.6% lower hazard ratios than those in quintile1. To further inv
